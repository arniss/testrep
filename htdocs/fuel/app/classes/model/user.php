...
class Model_User extends \Orm\Model
{
	...
	protected static $_observers = array(
        ...
        {
            $form->add('username', 'Username:')->add_rule('required')->add_rule('max_length', 10);
            //$val->add_field('username', 'Username', 'required|min_length[3]|max_length[10]');
            $form->add('password', 'Choose Password:', array('type'=>'password'))->add_rule('required')->add_rule('min_length', 6)->add_rule('max_length', 20);
